start_msg = """እንኩዓን ወደ Remedial Tricks በደህና መጡ !!!"""

help_msg = """
Welcome to our Bot Help Center! Here are some commands to assist you:

📌 /register - Start the registration process.
📌 /aboutus - Learn more about our organization.
📌 /contactus - Get in touch with our support team.

If you need further assistance or have any other questions, don't hesitate to reach out. We are committed to providing you with the best possible experience.

Thank you for choosing our Bot! We look forward to serving you and helping you succeed.
