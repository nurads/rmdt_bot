...
def get_payment_options():
    ...
    reply.add(InlineKeyboardButton("🚩ኦሮሚያ international ባንክ", callback_data="_payment_oib"))
    ...
    reply.add(InlineKeyboardButton("🚩AUT Exam - 300 Birr", callback_data="_payment_aut_300"))
...
@bot.callback_query_handler(
    func=lambda call: call.data in ["_class_a", "_class_b", "_class_c", "_class_d", "_aut_exam"]
)
